...
namespace Svg.Contrib.Render.EPL.Demo
{
  ...
  public partial class label
  {
    ...
    public virtual string tspan3452
    {
      get
      {
        return this.GetText("tspan3452");
      }
      set
      {
        this.SetText("tspan3452", value);
      }
    }

    public virtual bool Visible_tspan3452
    {
      get
      {
        return this.GetVisible("tspan3452");
      }
      set
      {
        this.SetVisible("tspan3452", value);
      }
    }

    public virtual string tspan3448
    {
      get
      {
        return this.GetText("tspan3448");
      }
      set
      {
        this.SetText("tspan3448", value);
      }
    }

    public virtual bool Visible_tspan3448
    {
      get
      {
        return this.GetVisible("tspan3448");
      }
      set
      {
        this.SetVisible("tspan3448", value);
      }
    }
  } // class
} // namespace
