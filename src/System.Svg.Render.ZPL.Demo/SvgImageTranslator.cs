...
{
  //[PublicAPI]
  //public class SvgImageTranslator : System.Svg.Render.ZPL.SvgImageTranslator
  //{
  ...
  //  public SvgImageTranslator([NotNull] System.Svg.Render.ZPL.ZplTransformer zplTransformer,
  ...
  //      {
  //        var eplStream = this.ZplCommands.BarCode(horizontalStart,
  //                                                 verticalStart,
  //                                                 rotation,
  //                                                 barCodeSelection,
  //                                                 narrowBarWidth,
